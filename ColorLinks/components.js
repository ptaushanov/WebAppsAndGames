...
let levelSettings;
let levelIndex = 0; // Index for the levelSettings
...
const createCardsAndBehaviour = (cardsArray, cardContainer) => {
    createCards(levelSettings[levelIndex], cardsArray);

    //Adding just the needed colors;
    shuffle(colorPallet);
    let currentColors = colorPallet.slice().splice(0, levelSettings[levelIndex].count / 2);
